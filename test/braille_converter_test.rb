...
class BrailleConverterTest < Minitest::Test
  ...
  def test_it_measures_fully_encoded_braille_message_length
    message = "transmission"
    bc = BrailleConverter.new(message)

    assert_equal 74, bc.measure_row_length
  end

  def test_it_limits_braille_line_length
    message = "transmission"
    bc = BrailleConverter.new(message)

    assert_equal nil, bc.limit_braille_line_length
  end
end
